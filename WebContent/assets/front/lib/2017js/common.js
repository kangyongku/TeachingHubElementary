$(function() {
  ...
  var databoxToggle = (function() {
    ...
    btn.on("click", function(e) {
      ...
      //if($(this).parents().find('.commondata_box')) $.cookie('thub_common_data' , 'hide');
    });
...
/*  $(".class_tab_wrap>ul>li").click(function(){
  ...
  $(".sub_content").find(".class_tab_content.on").show();*/
	...
	$('.replyBtn').click(function(){
		...
		$(this).toggleText('답변', '답변취소');
		$(this).toggleClass('cancel');
		$(this).closest('li').find('.re_reply_write').toggleClass('on');
	  });
  ...
  function modal_close(_target) {
	...
	$(document).ready(function(){
		...
		if(curLocation.indexOf("A001")>-1){
			$("#menu_depth_lf_01").addClass("on");
		}else if(curLocation.indexOf("A002")>-1){
			$("#menu_depth_lf_02").addClass("on");
		}else if(curLocation.indexOf("A003")>-1){
			$("#menu_depth_lf_03").addClass("on");
		}
	...
	*/
	/* 2018.02.02 추가수정 */
			$(".menu_depth_lf>li>a").click(function(){
				$(".menu_depth_lf>li>a").removeClass("on");
				$(this).addClass("on");
			});
	/*// 2018.02.02 추가수정 */
	...
	$(".menu_depth_lf > li > a").click(function(){
		$(".s-menu").hide();
		$('.my_search > img').attr("src","/assets/front/2017img/main/main11.gif");
	...
	$(".my_search").click(function(){
		...
		$('.my_search > img').attr("src","/assets/front/2017img/main/main11_on.gif");
	...
	$(".s_close").click(function(){
		...
		//$('.my_btn1 > img').attr("src","/assets/front/2017img/main/main10_off.gif");
		$(".s-menu7").stop().slideUp("fast");
		$('.my_search > img').attr("src","/assets/front/2017img/main/main11.gif");
		$(".s-menu8").stop().slideUp("fast");
		$(".menu_depth_lf>li>a").removeClass("on"); /* 2018.02.02 추가수정 */
		$(".menu_depth_rt a").removeClass("on"); /* 2018.02.02 추가수정 */
	});
	...
	/*$(".menu_depth_rt a").click(function(){
	$(".menu_depth_rt a").removeClass("on");
	$(this).addClass("on");
});*/	
	...
	for(var img_n=0;img_n<$(".tab2 li").length;img_n++){
		$(".tab2 li:eq("+img_n+") > a.on").append("<img src='/assets/front/2017img/sub/s1_01.gif' alt='' />");
	}
	
	
	
	for(var img_n=0;img_n<$(".pop_menu_tab3 > li").length;img_n++){
	$(".pop_menu_tab3 > li:eq("+img_n+") > a.on").append("<img src='/assets/front/2017img/sub/s1_01.gif' alt='' />");
	}
