...
<%
	...
	String tel1 = (member.getTel1()==null)?"":member.getTel1();
%>
<style>
	.table th, .table td {
 	...
 	<tr>
		...
		<td colspan="5">
			<select name="tel1" style="width:100px">
				...
				<option value="031" <% if( tel1.equals("031")){ %>selected<% } %>>031</option>
				...
				<option value="070" <% if( tel1.equals("070")){ %>selected<% } %>>070</option>
				<option value="0505" <% if( tel1.equals("0505")){ %>selected<% } %>>0505</option>
			</select>
