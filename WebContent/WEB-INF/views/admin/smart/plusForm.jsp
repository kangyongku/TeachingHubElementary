...
<div class="btn-toolbar">
	...
	<button class="btn" onclick="goList();">미리보기</button>
</div>
...
<div class="well">
	<div style="margin:10px;">
		...
		<tr>
			<th>역사사건</th>
			<td colspan="3">
				<input type="text" name="historyExp" style="width:500px;"/>
			</td>
		</tr>
		<tr>
			<th colspan="4">
...
function historyHandler()
{
	$.ajax({
		...
		type : 'post' ,
		async : false ,
		data : $('form[name=historyForm]').serialize() ,
		dataType : 'json' ,
		error : function(){
