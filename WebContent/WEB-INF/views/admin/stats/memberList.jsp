...
<div class="btn-toolbar">
    <a class="btn btn-danger" href="#">가입회원</button>
	<a class="btn btn-primary" href="memberSecederList.do">탈퇴회원</a>
</div>
...
<div style="float:left;font-weight:bold;font-size:11pt;">
	누적가입 : <%=new DecimalFormat("###,###").format(totalCount) %>
</div>
