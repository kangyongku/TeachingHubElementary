...
<div class="btn-toolbar">
	<a class="btn btn-primary" href="requestList.do">고객문의</a>
	<a class="btn btn-danger" href="#">교과서 자료요청</button>
	<a class="btn btn-primary" href="contentsList.do">교과서 내용문의</a>
</div>
...
<div>
	...
	<tr>
		...
		<td style="border:1px solid #eee;" colspan="3">
			<select name="findCategory" class="findCategory" style="width:100px;margin-right:10px;float:left;">
