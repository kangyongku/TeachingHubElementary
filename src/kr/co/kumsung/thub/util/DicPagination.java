...
public class DicPagination {
	...
	public DicPagination(int currentPage , int pageSize , int blockSize , int totalRows)
	{
	...
	public void firstPrint()
	{
		...
		if(this.startPageNum > this.pageSize)
			pageString.append("<a href=\"javascript:goList('" + (this.startPageNum  - 1) + "');\"><img src=\"/assets/front/img/btn/page_first.gif\" alt=\"처음\"></a>\r\n");		
	}
	...
	public void prePrint()
	{
		...
		if(this.currentPage > 1)
			pageString.append("<a href=\"javascript:goList('" + (this.currentPage  - 1) + "');\"><img src=\"/assets/front/dic/img/btn/paging_left.png\" alt=\"이전 5페이지 이동\"></a>\r\n");		
	}
	...
	public void postPrint()
	{
		...
		if(this.currentPage < this.totalPages )
			pageString.append("<a href=\"javascript:goList('" + this.endPageNum + "');\" class=\"nextEnd\"><img src=\"/assets/front/dic/img/btn/paging_right.png\" alt=\"다음 10페이지 이동\"></a>\r\n");
	}
	...
	{	
		pageString.append("<span class=\"paging_wp style\">\r\n");
		...
		for(int i = startPageNum ; i <= endPageNum ; i++)
		{
			...
			String uiClass = ( i == startPageNum ) ? "class=\"first\"" : "";
			
			if(i == this.currentPage)
				pageString.append("<a href=\"javascript:goList('" + i + "');\" " + uiClass + "><em>" + i + "</em></a>\r\n");
			else
				pageString.append("<a href=\"javascript:goList('" + i + "');\" " + uiClass + ">" + i + "</a>\r\n");
		}
