...
public class Pagination {
	...
	public void prePrint()
	{
		...
		if(this.currentBlock > 1)
			pageString.append("<li><a href=\"" + this.linkPage + "?" + this.queryString + this.amp + "pg=" + (((this.currentBlock - 2) * this.pageSize) + 1) + "\">" + this.firstLink + "</a></li>");
		else
		...
		*/
		...
		if(this.currentPage > 1)
			pageString.append("<li><a href=\"javascript:goList('" + (this.currentPage  - 1) + "');\">" + this.prevLink + "</a></li>");		
	}
	...
	public void postPrint()
	{
		...
		if(this.currentPage < this.totalPages )
			pageString.append("<li><a href=\"javascript:goList('" + this.endPageNum + "');\">" + this.nextLink + "</a></li>");
	...
	{	
		for(int i = startPageNum ; i <= endPageNum ; i++)
		{
			...
			if(i == this.currentPage)			
				pageString.append("<li><a href=\"#\" class=\"current-page\">" + this.preWrap + i +  this.postWrap + "</a></li>");
			else
