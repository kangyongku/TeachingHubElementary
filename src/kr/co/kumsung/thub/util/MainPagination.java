...
public class MainPagination {
	...
	public MainPagination(int currentPage , int pageSize , int blockSize , int totalRows)
	{
	...
	public void prePrint()
	{
		...
		if(this.currentPage > 1)
			pageString.append("<a href=\"javascript:goList('" + (this.currentPage  - 1) + "');\"><img src=\"/assets/front/img/newmain/btn_prev.png\" alt=\"이전 5페이지 이동\"></a>\r\n");		
	}
	...
	public void postPrint()
	{
		...
		if(this.currentPage < this.totalPages )
			pageString.append("<a href=\"javascript:goList('" + (this.currentPage  + 1) + "');\" class=\"next\"><img src=\"/assets/front/img/newmain/btn_next.png\" alt=\"다음 5페이지 이동\"></a>\r\n");
	}
	...
	{	
		...
		for(int i = startPageNum ; i <= endPageNum ; i++)
		{
			...
			if(i == this.currentPage){
				pageString.append("<a class=\"on\" href=\"javascript:goList('" + i + "');\">" + i + "</a>\r\n");
			}else{
				if(i== totalPages){
					pageString.append("<a href=\"javascript:goList('" + i + "');\" class=\"end\">" + i + "</a>\r\n");
				}else{
					pageString.append("<a href=\"javascript:goList('" + i + "');\">" + i + "</a>\r\n");
				}
			}
		}
