...
public class FrontPagination2 {
	private static final Logger logger = LoggerFactory.getLogger(FrontPagination2.class);
	...
	// for design
	private String prevLink = "<img src='/assets/front/2017img/btn/btn_paging_prev.png' alt='이전'>";
	private String prevOffLink = "";
	private String nextLink = "<img src='/assets/front/2017img/btn/btn_paging_next.png' alt='다음'>";
	...
	public FrontPagination2(int currentPage , int pageSize , int blockSize , int totalRows)
	{
	...
	public void firstPrint()
	{
		...
		if(this.startPageNum > this.pageSize)
			pageString.append("<a href=\"javascript:goList('" + (this.firstPage) + "');\"><img src=\"/assets/front/img/btn/page_first.gif\" alt=\"처음\"></a>\r\n");		
	}
	...
	public void prePrint()
	{
		...
		if(this.currentPage > 1)
			pageString.append("<a href=\"javascript:goList('" + (this.currentPage  - 1) + "');\" class=\"arrow prev\"><img src=\"/assets/front/2017img/btn/btn_paging_prev.png\" alt=\"이전 5페이지 이동\"></a>\r\n");		
	}
	...
	public void postPrint()
	{
		...
		if(this.currentPage < this.totalPages )
			pageString.append("<a href=\"javascript:goList('" + (this.currentPage  + 1) + "');\"  class=\"arrow next\"><img src=\"/assets/front/2017img/btn/btn_paging_next.png\" alt=\"다음 10페이지 이동\"></a>\r\n");
	}
	...
	public void lastPrint()
	{
		...
		if(this.endPageNum <= this.totalPages)
			pageString.append("<a href=\"javascript:goList('" + (this.totalPages) + "');\"><img src=\"/assets/front/img/btn/page_last.gif\" alt=\"마지막\"></a>\r\n");		
	}
